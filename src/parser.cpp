...
{
	const static auto P = sat([](char c)->bool {return isdigit(c); });
	return parse(P, inp);
}

Reaction<char> fcl::lower(std::string inp)
{
	const static auto P = sat([](char c)->bool {return islower(c); });
	return parse(P, inp);
}

Reaction<char> fcl::upper(std::string inp)
{
	const static auto P = sat([](char c)->bool {return isupper(c); });
	return parse(P, inp);
}

Reaction<char> fcl::letter(std::string inp)
{
	const static auto P = sat([](char c)->bool {return isalpha(c); });
	return parse(P, inp);
}

Reaction<char> fcl::alphanumeric(std::string inp)
{
	const static auto P = sat([](char c)->bool {return isalnum(c); });
	return parse(P, inp);
}
